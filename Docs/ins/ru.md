...
Скачайте архив по [этой](https://drive.google.com/file/d/1Tf3dM5eRfAEaKKZisNR0pVCe43HCSaTp/view?usp=sharing) ссылке.
...
>
> [Это происходит потому, что данный LK собран на базе прошивки Redmi 10A (MIUI 12.5.4.0 RCZCNXM) и использует платформенный идентификатор MT6762G, а не кодовое имя устройства.](https://4pda.to/forum/index.php?act=findpost&pid=139550809&anchor=Spoil-139550809-2)
